...
from pipelines.callbacks.callbacks import SaveCheckpointsCallback
from pipelines.models.separator import Separator
from pipelines.utils import read_yaml
from pipelines.utils.process_audio import preprocess_audio
from pipelines.utils.statistics import StatisticsContainer
        ...
        if global_step % self.evaluate_step_frequency == 0:
            ...
            for track in self.mus.tracks:
                ...
                for source_type in self.target_source_types:
                    ...
                    # Calculate SDR using museval, input shape should be: (nsrc, nsampl,
                    # nchan).
