...
from pipelines.models.augementor import Augmentor
from pipelines.utils import int16_to_float32, read_yaml
from pipelines.utils.pitch import get_pitch_shifted_segment_samples
from pipelines.utils.sample import DistributedSamplerWrapper, SegmentSampler
...
class Dataset:
    ...
    def __getitem__(self, meta: Dict) -> Dict:
        ...
        for source_type in self.source_types:
            ...
            # E.g., waveforms: [(input_channels, audio_samples), (input_channels,
            # audio_samples)]
